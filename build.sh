...
echo "OpenCore version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
echo "Lilu version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
echo "VirtualSMC version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
echo "WhateverGreen version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
echo "AppleALC version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
v=${v#v}
echo "VoodooPS2 version: $v" | tee -a buildinfo
...
v=$(curl -sL https://api.github.com/repos/$r/releases/latest | jq -r ".tag_name")
echo "VoodooI2C version: $v" | tee -a buildinfo
